    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5 text-sm text-slate-600 space-y-3">
        <p>
          ...
          réassorts magasins, transferts inter-dépôts) et journalise les flux <strong>outbound</strong> (statuts
          d&apos;expédition, coûts logistiques imputés, pré-factures validées).
        </p>
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            ...
            <p className="text-sm text-slate-500">
              La plupart des ERP exportent leurs commandes en Excel — dépose ici le fichier reçu de l&apos;ERP
              KITEA pour créer automatiquement les commandes correspondantes.
            </p>
          </div>
          <div className="flex gap-2">
            <button onClick={() => erpService.downloadImportTemplate()} className="flex items-center gap-2 rounded-lg border border-slate-300 px-3 py-2 text-sm">
