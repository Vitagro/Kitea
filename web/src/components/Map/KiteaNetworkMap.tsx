...
const DEFAULT_CENTER: [number, number] = [32.5, -7.5];
...
// Carte interactive du réseau KITEA — chargée uniquement côté client (voir
// app/map/page.tsx, dynamic import ssr:false) car Leaflet dépend de `window`.
